...
public class CPU {
	...
	public void process() {
		...
		if(cond == COND_UC) { // unconditional
			...
			switch(cond) {				
				case COND_EQ:				flag =  this.getZ();
				case COND_NE:				flag = !this.getZ();
				case COND_CS & COND_HS:		flag =  this.getC();
				case COND_CC & COND_LO:		flag = !this.getC();
				case COND_MI:				flag =  this.getN();
				case COND_PL:				flag = !this.getN();
				case COND_VS:				flag =  this.getV();
				case COND_VC:				flag = !this.getV();
				case COND_HI:				flag =  this.getC() && !this.getZ();
				case COND_LS:				flag = !this.getC() ||  this.getZ();
				case COND_GE:				flag =  this.getN() ==  this.getV();
				case COND_LT:				flag =  this.getN() !=  this.getV();
				case COND_GT:				flag =  this.getN() ==  this.getV() && !this.getZ();
				case COND_LE: 				flag =  this.getN() !=  this.getV() &&  this.getZ();
